...
print("Thor, Iron Man, and Captain America are all sitting around a room.  The other Avengers are also somewhere nearby.")
...
if (person == "Thor") or (person == "thor"):
  ...
  print("He feels tired.")
elif (person == "Black widow") or (person == "black widow"):
  print("she also feels heavy and cant lift it.")
else:
