...
if answer.lower() == expected_answer:
    ...
    cards['Arkansas'] = 'little rock'
    cards['Montana'] = 'helena'
    cards['North Dakota'] = 'bismarck'
